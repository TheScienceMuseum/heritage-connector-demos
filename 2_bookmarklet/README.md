...
```
javascript:(function(a){%20a=document.createElement('script');a.type='text/javascript';a.src='//cdn.jsdelivr.net/gh/TheScienceMuseum/heritage-connector-demos@6a464a6/2_bookmarklet/script.min.js';document.getElementsByTagName('body')[0].appendChild(a);})();
```
