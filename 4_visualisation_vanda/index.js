...
const data_path = "https://smgco-heritageconnector.s3.eu-west-1.amazonaws.com/visualisation/visualisation_data_vanda.tsv"
...
const xScale = d3.scaleLinear().domain([-60, 60]);
const yScale = d3.scaleLinear().domain([-60, 60]);
